...
char fname_zemaxin = "4936_EX_1mmoff_0.dat";   //put name of zemax input array file  
char fname_zemaxout = "Exited_photons.dat";    //select name of zemax output array file 
